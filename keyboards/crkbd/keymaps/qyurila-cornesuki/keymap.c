...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EXTEND] = LAYOUT_split_3x6_3(                           // HANJ
    ...
    XXXXXXX, C(KC_Y), C(KC_X), C(KC_C), C(KC_Z), C(KC_V),   KC_PSCR, KC_BSPC, CAPSWRD, KC_CAPS, KC_INS,  KC_PAUS,
  ...
  [_FUNC] = LAYOUT_split_3x6_3(
    ...
    DEBUG,   KC_F12,  KC_F3,   KC_F2,   KC_F1,   XXXXXXX,   XXXXXXX, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, XXXXXXX,
