...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_3x6_3(
    ...
    TD_LANG, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX,
  //--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
  ...
  [_SYMBOL] = LAYOUT_split_3x6_3(
    ...
    XXXXXXX, KC_ASTR, XXXXXXX, KC_PSLS, KC_5,    KC_LCBR,   KC_RCBR, KC_6,    KC_COMM, KC_DOT,  KC_SLSH, L_TG_NP,
  //--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
  ...
  [_NUMPAD] = LAYOUT_split_3x6_3(
    ...
    KC_VOLD, XXXXXXX, KC_PDOT, KC_PCMM, KC_PEQL, XXXXXXX,   KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PDOT, L_TG_NP,
  //--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
                               KC_ESC,  L_E_SPC, XXXXXXX,   KC_PENT, KC_P0,   KC_PDOT
  ),

  [_FUNC] = LAYOUT_split_3x6_3(
    TD_SLPW, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET,
  ...
  //--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
                               L_TG_LK, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, _______
  ),
  ...
  [_EXTEND] = LAYOUT_split_3x6_3(
    ...
    L_TG_MS, C(CM_Y), C(KC_X), C(KC_C), C(KC_Z), C(CM_V),   XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, KC_APP,  KC_PAUS,
  //--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
  ...
  [_MOUSE] = LAYOUT_split_3x6_3(
    ...
    L_TG_MS, C(CM_Y), C(KC_X), C(KC_C), C(CM_V), C(KC_Z),   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ACL0, XXXXXXX,
  //--------+--------+--------+--------+--------+--------| |--------+--------+--------+--------+--------+--------|
